@include('layouts.header')
        ...
        <title> 
            ...
            @else
                (Admin) Data Pendakian | Mountdaki
            @endif
        </title>
    </head>
    <body>
        ...
        <div class="container">         
            ...
            @else
                @php
                    $m = $data['data']
                @endphp
                <center><h2 class="mt-3">Data Pendakian</h2></center>
                    ...
                    <tbody>
                        @if ($m > 1)
                            @foreach ($m as $d)
                                <tr>
                                    ...
                                    <td>                                          
                                        @if ($d['status'] == 'pending')
                                            <button class="btn btn-success"><a style="text-decoration: none; color:white" href="/climbing_registrations/approve/{{ $d['id'] }}">Setujui</a></button>                                        
                                            <button class="btn btn-danger"><a style="text-decoration: none; color:white" href="/climbing_registrations/decline/{{ $d['id'] }}">Tolak</a></button>                                        
                                        @endif
                                    </td>
                                </tr>                            
                            @endforeach                            
                        @else
                            <tr>
                                ...
                                <td>
                                    @if ($d['status'] == 'pending')
                                        <button class="btn btn-success"><a style="text-decoration: none; color:white" href="/climbing_registrations/approve/{{ $m['id'] }}">Setujui</a></button>                                        
                                        <button class="btn btn-danger"><a style="text-decoration: none; color:white" href="/climbing_registrations/decline/{{ $m['id'] }}">Tolak</a></button>                                        
                                    @endif
                                </td>
                            </tr>       
                        @endif
